...
import { GroupsLeadEvents } from "./groups-lead-events"
...
export default function EnglishGroupsThankYouPage() {
  return (
        ...
        <div className="container mx-auto px-4 py-12 sm:py-16 lg:py-24 relative z-10">
          <div className="max-w-2xl mx-auto flex flex-col items-center text-center space-y-8">
            ...
            <p className="text-lg lg:text-xl text-muted-foreground leading-relaxed">
              ...
              lekcji próbnej w kameralnej grupie.
            </p>
            ...
            <div className="flex flex-row items-center gap-4">
              ...
              >
                <Link href="/angielskigrupy">Wróć na stronę grup</Link>
              </Button>
              <a
