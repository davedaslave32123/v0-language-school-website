...
import { MatematykaLeadEvents } from "./matematyka-lead-events"
...
export default function MatematykaThankYouPage() {
  return (
    <main className="min-h-screen">
      <MatematykaLeadEvents />
        ...
        <div className="container mx-auto px-4 py-12 sm:py-16 lg:py-24 relative z-10">
          <div className="max-w-2xl mx-auto flex flex-col items-center text-center space-y-8">
            ...
            <p className="text-lg lg:text-xl text-muted-foreground leading-relaxed">
              Skontaktuję się z Tobą wkrótce, aby dobrać odpowiedniego tutora i ustalić dogodny termin bezpłatnej
              lekcji próbnej z matematyki dla Twojego dziecka.
            </p>
            ...
            <div className="flex flex-row items-center gap-4">
              ...
              >
                <Link href="/matematyka">Wróć na stronę zajęć</Link>
              </Button>
              <a
