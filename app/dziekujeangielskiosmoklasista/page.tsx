...
import { OsmoklasistaLeadEvents } from "./osmoklasista-lead-events"
...
export default function OsmoklasistaThankYouPage() {
  return (
    <main className="min-h-screen">
      <OsmoklasistaLeadEvents />
        ...
        <div className="container mx-auto px-4 py-12 sm:py-16 lg:py-24 relative z-10">
          <div className="max-w-2xl mx-auto flex flex-col items-center text-center space-y-8">
            ...
            <p className="text-lg lg:text-xl text-muted-foreground leading-relaxed">
              Skontaktujemy się z Tobą wkrótce, aby ustalić dogodny termin bezpłatnej lekcji próbnej dla Twojego
              dziecka.
            </p>
            ...
            <div className="flex flex-row items-center gap-4">
              ...
              >
                <Link href="/angielskiosmoklasista">Wróć na stronę kursu</Link>
              </Button>
              <a
