...
const reviewsSpanish: { image: string; alt: string }[] = [
  { image: "/images/hiszpanski/reviews/review-monika.png", alt: "Opinia klientki Monika" },
  { image: "/images/hiszpanski/reviews/review-justyna.png", alt: "Opinia klientki Justyna" },
  { image: "/images/hiszpanski/reviews/review-natalia.png", alt: "Opinia klientki Natalia" },
]

export function SpanishTestimonialsSection() {
  return (
    <section className="py-12 sm:py-16 lg:py-24 bg-muted/30">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-6">
          {reviewsSpanish.map((review, index) => (
            <Card
              key={index}
